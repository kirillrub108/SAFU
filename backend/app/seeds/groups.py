...
def seed_groups(db: Session) -> list[Group]:
    """Заполнение групп."""
    groups_data = [
        {"code": "521428", "name": "521428", "year": 2},
        {"code": "521423", "name": "521423", "year": 2},
        {"code": "521424", "name": "521424", "year": 2},
        {"code": "521425", "name": "521425", "year": 2},
        {"code": "521427", "name": "521427", "year": 2},
        # Гуманитарный институт (г. Северодвинск)
        {
            "code": "521523",
